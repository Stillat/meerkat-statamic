...
Route::middleware('meerkat-api-public')->group(function () {
    ...
    Route::get('threads/{threadId}/children/{commentId}', [ThreadController::class, 'children'])->name('thread.children');
...
Route::middleware('meerkat-api-privileged')->group(function () {
    ...
    Route::get('comments/{commentId}/history', [ThreadController::class, 'history'])->name('comments.history');
    Route::get('comments/{commentId}/revisions', [ThreadController::class, 'revisions'])->name('comments.revisions');
