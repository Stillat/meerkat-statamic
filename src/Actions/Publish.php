...
class Publish extends Action
{
    ...
    {
        return __('meerkat::general.publish_comment');
    }

    public function confirmationText(): string
    {
        return __('meerkat::general.publish_comment_confirmation');
    }

    public function buttonText(): string
    {
        return __('meerkat::general.publish_comment_button');
    }
    ...
    {
        $succeeded = $items->filter(fn ($comment) => $this->comments->publish($comment->id))->count();

        return $this->reportBulkOutcome($succeeded, $items->count(), 'meerkat::general.published_comment');
    }
}
